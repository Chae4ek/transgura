...
public class PlayerController extends System implements CollisionSubscriber {
  ...
  public void beginContact(final Contact contact) {
    ...
    if (CollisionProcessor.isFixturesCollision(contact, "PLAYER", "EXIT")) {
      ...
      getParent().getComponent(Text.class).isDrawn = true; // show hint 'E'
    }
      ...
      if (isEnabled()) {
        Game.getScene()
            ...
            .addDeferredEvent(
                () ->
                    getParent()
                        .getComponent(PhysicalBody.class)
                        .getBody()
                        .setTransform(Player.RIP_POSITION, 0));
      }
    }
  ...
  public void endContact(final Contact contact) {
    ...
    if (CollisionProcessor.isFixturesCollision(contact, "PLAYER", "EXIT")) {
      interactionSub = null;
      getParent().getComponent(Text.class).isDrawn = false; // hide hint 'E'
    }
  }
}
