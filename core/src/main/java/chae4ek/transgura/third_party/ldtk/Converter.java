...
public class Converter {
  ...
  public static OffsetDateTime parseDateTimeString(final String str) {
  ...
  public static OffsetTime parseTimeString(final String str) {
  ...
  public static String toJsonString(final LDtk obj) throws JsonProcessingException {
  ...
  private static void instantiateMapper() {
    ...
    reader = mapper.readerFor(LDtk.class);
    writer = mapper.writerFor(LDtk.class);
  }
