...
public enum Flag {
  ...
  public String toValue() {
    switch (this) {
      case DISCARD_PRE_Csv_INT_GRID:
        return "DiscardPreCsvIntGrid";
      case EXPORT_PRE_Csv_INT_GRID_FORMAT:
        return "ExportPreCsvIntGridFormat";
      case IGNORE_BACKUP_SUGGEST:
        return "IgnoreBackupSuggest";
      case MULTI_WORLDS:
        return "MultiWorlds";
      case PREPEND_INDEX_TO_LEVEL_FILE_NAMES:
        return "PrependIndexToLevelFileNames";
      case USE_MULTILINES_TYPE:
        return "UseMultilinesType";
    }
    return null;
  }

  @JsonCreator
  public static Flag forValue(final String value) throws IOException {
