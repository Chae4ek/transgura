...
public enum ImageExportMode {
  ...
  public String toValue() {
    switch (this) {
      case LAYERS_AND_LEVELS:
        return "LayersAndLevels";
      case NONE:
        return "None";
      case ONE_IMAGE_PER_LAYER:
        return "OneImagePerLayer";
      case ONE_IMAGE_PER_LEVEL:
        return "OneImagePerLevel";
    }
    return null;
  }

  @JsonCreator
  public static ImageExportMode forValue(final String value) throws IOException {
