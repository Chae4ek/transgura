...
/**
 * An enum describing how the the Entity tile is rendered inside the Entity bounds. Possible values:
...
public enum TileRenderMode {
  ...
  public String toValue() {
    switch (this) {
      ...
      case FIT_INSIDE:
        return "FitInside";
      case FULL_SIZE_CROPPED:
        return "FullSizeCropped";
      case FULL_SIZE_UNCROPPED:
        return "FullSizeUncropped";
      case NINE_SLICE:
        return "NineSlice";
      case REPEAT:
        return "Repeat";
  ...
  @JsonCreator
  public static TileRenderMode forValue(final String value) throws IOException {
